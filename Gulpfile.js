// generated on 2017-08-22 using generator-webapp 3.0.1
...
gulp.task('html-copy-and-render', () => {
...
gulp.task('serve', () => {
  runSequence(['clean', 'wiredep'], ['styles', 'scripts', 'fonts', 'html-copy-and-render'], () => {
    browserSync.init({
      notify: false,
      port: 9000,
      server: {
    ...
    gulp.watch('app/**/*.html', ['html-copy-and-render']);
